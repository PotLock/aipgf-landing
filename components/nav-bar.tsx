...
const NavBar: NextPage<NavBarType> = ({ className = "" }) => {
  return (
    <header
      className={`self-stretch bg-aipgf-white border-aipgf-aqua-haze border-t-[1px] border-b-[1px] border-solid box-border flex flex-row items-start justify-start py-[0.687rem] px-[5rem] top-[0] z-[99] sticky max-w-full text-center text-[0.938rem] text-communityintercomcom-black-pearl font-menlo mq825:pl-[2.5rem] mq825:pr-[2.5rem] mq825:box-border ${className}`}
    >
