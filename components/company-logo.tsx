...
const CompanyLogo: NextPage<CompanyLogoType> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div className="self-stretch sm:flex-col sm:space-y-6 flex flex-row items-center justify-between py-[0rem] px-[14.125rem] gap-[1.25rem] sm:pl-[1.25rem] sm:pr-[1.25rem] sm:box-border mq825:pl-[3.5rem] mq825:pr-[3.5rem] mq825:box-border mq1425:flex-wrap mq1425:pl-[7.063rem] mq1425:pr-[7.063rem] mq1425:box-border">
        <img
