  ...
  return (
    ...
    >
      <div className="flex-1 bg-aipgf-shark1 flex flex-row items-center justify-start py-[1.937rem] px-[5rem] box-border [row-gap:20px] max-w-full lg:flex-wrap mq825:pl-[2.5rem] mq825:pr-[2.5rem] mq825:box-border">
        <div className="flex-[0.3512] flex flex-row items-center justify-between py-[1rem] pl-[0.5rem] pr-[22rem] box-border min-w-[18.813rem] max-w-full gap-[1.25rem] lg:flex-1 sm:pr-[11rem] sm:box-border mq825:flex-wrap mq825:justify-center">
          <img
        ...
        <div
          className="flex flex-row items-center justify-center py-[0.718rem] px-[0rem] box-border gap-[0.4rem] max-w-full cursor-pointer sm:flex-wrap"
        ...
        <div className="flex-1 flex flex-row items-center justify-center py-[0.5rem] pl-[10.062rem] pr-[0.5rem] box-border gap-[0.5rem] min-w-[18.813rem] max-w-full text-left text-[0.963rem] lg:flex-1 sm:pl-[5rem] sm:box-border mq825:flex-wrap">
